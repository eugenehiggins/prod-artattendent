...
if ( is_user_logged_in() ):
	...
	if ( $payments ) :
		...
		<table id="edd_user_history-off" class="edd-table table">
			<thead>
				<tr class="edd_purchase_row">
					<?php do_action('edd_purchase_history_header_before'); ?>
					<th class="edd_purchase_id"><?php _e('Artwork','easy-digital-downloads' ); ?></th>
					
					<th class="edd_purchase_amount"><?php _e('Amount','easy-digital-downloads' ); ?></th>
					<th><?php _e( 'Seller', 'edd_fes' ) ?></th>
			...
			<?php foreach ( $payments as $payment ) : ?>
				...
				<tr class="edd_purchase_row">
					...
					<td class="edd_purchase_id"><?php echo anagram_get_order_title( $payment->ID );//echo $payment->number ?></td>
					...
					<td class="edd_seller">
						...
						<?php echo anagram_get_seller_name( $payment->ID ); ?>
					</td>
