...
if (EDD_FES()->vendors->vendor_can_view_receipt(false, $key)){
	...
	?>
		...
		<table id="edd_purchase_receipt_products" class="table table-condensed  table-striped">
			<thead>
...
echo esc_html( $item['name'] ); ?>
	...
	<table id="edd_purchase_receipt" class="table table-condensed  table-striped">

			<?php do_action( 'fes_payment_receipt_before', $payment ); ?>
			<tr>
				<td><strong><?php _e( 'Payment', 'edd_fes' ); ?>:</strong></td>
				<td><?php echo edd_get_payment_number( $payment->ID ); ?></td>
			</tr>
