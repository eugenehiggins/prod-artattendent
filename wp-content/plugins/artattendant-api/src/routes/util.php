...
class util {
	...
	protected function mailchimp() {
		$data[ 'title' ] = __( 'Join Our Mailing List', 'artattendant-license-manager' );
		$data[ 'message' ] = __( 'Get news, WordPress tricks and special saving.', 'artattendant-license-manager' );
