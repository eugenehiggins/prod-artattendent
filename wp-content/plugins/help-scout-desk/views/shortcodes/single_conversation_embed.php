		...
		<div class="author">
			<span class="posted-on">
				...
				<?php
					...
					$time = '<time datetime="'.esc_attr__( $item['createdAt'] , 'help-scout-desk' ).'">'.date_i18n( get_option( 'date_format' ), strtotime( esc_attr__( $item['createdAt'] , 'help-scout-desk' ) ) ).'</time>';
					...
					<div class="panel-heading clearfix">
						...
						<h3 class="panel-title pull-right">
							<?php
								...
								$time = '<time datetime="'.esc_attr__( $data['createdAt'] , 'help-scout-desk' ).'">'.date_i18n( get_option( 'date_format' ), strtotime( esc_attr__( $data['createdAt'] , 'help-scout-desk' ) ) ).'</time>';
