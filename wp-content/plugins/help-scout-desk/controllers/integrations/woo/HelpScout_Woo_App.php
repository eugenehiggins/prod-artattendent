...
/**
 * Help Scout Woo App Controller
 *
 * @package HelpScout_Desk
 * @subpackage HS API
 */
class HelpScout_Woo_App extends HSD_Controller {
	const APP_ACTION = 'helpscout_woo';
	const APP_AJAX_HANDLER = 'helpscout_woo_action';
	...
	public static function init() {
		...
		// Woo Payment history within HS sidebar - main APP
	...
	public static function help_scout_app() {
		...
		$woo_hsd = new HelpScout_Woo_App_Handler();
		$woo_hsd->process();
	}
	...
	public static function register_settings() {
		...
		// Settings
		$settings = array(
			'hsd_woo_site_settings' => array(
				'title' => 'Help Scout Woo Setup',
				'weight' => 50,
				'callback' => array( __CLASS__, 'display_woo_general_section' ),
				'settings' => array(
					'app_url' => array(
	...
	public static function display_woo_general_section() {
